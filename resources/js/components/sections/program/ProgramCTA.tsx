...
const ProgramCTA = forwardRef<HTMLDivElement>((props, ref) => (
    <section ref={ref} className="py-16 bg-gray-50 opacity-0">
            ...
            <div className="bg-gradient-to-r from-blue-700 to-blue-500 rounded-3xl p-8 md:p-12 relative overflow-hidden transform transition-all duration-500 hover:scale-[1.01] hover:shadow-xl">
                ...
                <div className="relative z-10 max-w-3xl">
                    ...
                    <p className="text-blue-50 mb-8 text-lg">
                        Konsultasikan kebutuhan belajar Anda dengan tim kami dan
                        dapatkan rekomendasi program yang sesuai dengan tujuan
                        karir Anda.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4">
                        <CTAButton
                            href="#"
                            className="bg-yellow-300 text-blue-800"
                        >
                            <svg
